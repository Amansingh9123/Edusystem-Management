...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      {{-- <li class="nav-item">
        <a class="nav-link active" href="#" data-toggle="collapse " data-target="#collapseBootstrap"
        ...
        <div id="collapseBootstrap" class="collapse show" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{url('/view_student')}}">View Student</a>
                   ...
                   <!--  <tfoot>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$info->category}}</td>
                        <td><img src="faculty_images/{{$info->image}}" height="68px" width="68px"></td>
                        
                        <td><a href="{{url('/edit_faculty')}}{{$info->id}}"><button class="btn btn-success">Edit</button></a> 
                        <a href="{{url('/delete_faculty')}}{{$info->id}}"> <button onclick="return confirm('are you sure to delete this?')" class="btn btn-danger">Delete</button></a>
                    </td>
                </tr>
                       @endforeach
                    </tbody>
