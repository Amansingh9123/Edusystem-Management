    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse show" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item active" href="{{url('/add_course')}}">Add Course</a>
                ...
                <div class="card-body">
                  ...
                  @endif
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  name="course_price" id="exampleInputPassword1"  >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Course Duration</label>
                      <input type="text" class="form-control"  name="course_duration" id="exampleInputPassword1"  >
                    </div>

                     <div class="form-group">
                      <label for="exampleInputPassword1">Course Description</label>
                      <textarea  type="text" class="form-control" placeholder="Description" name="course_description"></textarea>
                    </div>
