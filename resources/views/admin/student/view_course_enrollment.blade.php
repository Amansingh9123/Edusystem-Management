      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse show" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{url('/view_enrolled_student')}}">Enrolled Student</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="admin_assets/img-profile rounded-circle" src="img/boy.png" style="max-width: 60px">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                   ...
                   <!--  <tfoot>
                    ...
                    <tbody>
                      @foreach($course_enrollment->all() as $info)
                      <tr>
                        <td>{{$info->id}}</td>
                        ...
                        <td><a href="{{url('/edit_student')}}{{$info->id}}"><button class="btn btn-success">Edit</button></a> 
                        <a href="{{url('/delete_student')}}{{$info->id}}"> <button onclick="return confirm('are you sure to delete this?')" class="btn btn-danger">Delete</button></a></td>
                      </tr>
                       @endforeach
                    </tbody>
                  </table>
